...
# Parameters
PHENOPLIER_NOTEBOOK_FILEPATH = "projects/chronotype/nbs/20_gene_corrs/15-create_lv_specific_gene_correlations.ipynb"
...
# %% tags=[] magic_args="-s \"$PHENOPLIER_NOTEBOOK_DIR\" \"$PROJECTS_TRAIT_KEY\" \"$LV_CHUNKS\"" language="bash"
# set -euo pipefail
# IFS=$'\n\t'
#
