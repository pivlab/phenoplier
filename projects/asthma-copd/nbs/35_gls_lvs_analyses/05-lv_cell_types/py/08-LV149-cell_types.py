...
# %%
# what is there in these projects?
_tmp = lv_data.loc[["SRP008145"]].dropna(how="all", axis=1).sort_values(
    LV_NAME, ascending=False
)
...
reduced_plot_data = reduced_plot_data.replace(
    {
        SELECTED_ATTRIBUTE: {
            ...
            "embyonic kidney cell line (CRE/IFNB single-hit)": "embyonic kidney cell line",
            "embyonic kidney cell line (CRE/IFNB multi-hit)": "embyonic kidney cell line",
        }
    }
)
